...
import '../cubit/customer_profile_edit_cubit.dart';
import '../cubit/customer_profile_edit_state.dart';
...
class CustomerProfileEditPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider<CustomerProfileEditCubit>(
      create: (context) => CustomerProfileEditCubit(
        getCustomerProfileUseCase: context.read<GetCustomerProfileUseCase>(),
        updateCustomerProfileUseCase: context
            .read<UpdateCustomerProfileUseCase>(),
        sessionCubit: context.read<SessionCubit>(),
      )..load(),
      child: const _CustomerProfileEditView(),
    );
  }
}

class _CustomerProfileEditView extends StatelessWidget {
  const _CustomerProfileEditView();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: BlocConsumer<CustomerProfileEditCubit, CustomerProfileEditState>(
          listener: (context, state) {
            if (state.status == CustomerProfileEditStatus.success) {
              ToastUtils.showSuccess(context, localizations.profileSaveSuccess);
              Navigator.of(context).pop(true);
            }

            if (state.status == CustomerProfileEditStatus.failure &&
          ...
          builder: (context, state) {
            ...
            final cubit = context.read<CustomerProfileEditCubit>();
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        prefixIcon: prefixIcon != null
            ? Icon(prefixIcon, color: AppColors.brandRed, size: 22)
            : null,
