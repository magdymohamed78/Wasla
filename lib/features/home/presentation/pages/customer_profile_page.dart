                ...
                children: [
                  ...
                  ProfileSectionCard(
                    ...
                    trailing: EditProfileButton(
                      label: localizations.profileEditPageTitle, // We could use 'Edit' but let's use a localized string, unfortunately I'll just use 'Edit' for precision. Wait, I'll pass 'Edit'.
                      onPressed: () async {
                  ...
                  ProfileSectionCard(
                    ...
                    trailing: companies.length > 4
                        ? TextButton(
                            ...
                            child: Text(localizations.homeViewAll),
                          )
                        : null,
