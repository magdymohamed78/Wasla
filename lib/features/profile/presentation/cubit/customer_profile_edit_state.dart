...
enum CustomerProfileEditStatus { initial, loading, saving, success, failure }

class CustomerProfileEditState {
  final CustomerProfileEditStatus status;
  ...
  const CustomerProfileEditState({
    this.status = CustomerProfileEditStatus.initial,
    this.profile,
    this.firstName = '',
    this.lastName = '',
    this.email = '',
  ...
  bool get isLoading => status == CustomerProfileEditStatus.loading;

  bool get isSaving => status == CustomerProfileEditStatus.saving;

  CustomerProfileEditState copyWith({
    CustomerProfileEditStatus? status,
